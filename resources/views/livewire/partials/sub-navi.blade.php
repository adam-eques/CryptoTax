            ...
            <div class="flex items-baseline text-sm space-x-2 lg:space-x-4 -ml-2 lg:-ml-4">
                @foreach($navItems as $navItem)
                    <a href="{{ route($navItem['route']) }}"
                       class="{{ request()->routeIs($navItem['route']) ? "lg:px-4 p-2 gap-2 text-blue-800 hover:text-blue-500 font-semibold inline-flex" : "lg:px-4 p-2 gap-2 text-blue-800 hover:text-blue-500 font-semibold inline-flex" }}">
