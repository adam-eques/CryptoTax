<div class="bg-white shadow-sm rounded-md py-4 px-8 mt-5">
    ...
    <div class="flex justify-between items-center py-3">
        ...
        <div class="flex items-center space-x-6">
            <div class="bg-color text-white rounded-full w-8 h-8 text-sm relative cursor-pointer hover:bg-indigo-700">
