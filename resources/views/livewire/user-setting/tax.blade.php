    ...
    <div class="px-5 py-5 md:px-10 md:py-10">
        <form wire:submit.prevent='submit'>
            ...
            <div>
                ...
                <div class="border flex items-center rounded-sm mt-4 px-5 @error('timezone_id') border-danger @enderror">
            ...
            <div class="mt-10">
                ...
                <div class="border flex items-center rounded-sm mt-4 px-5 @error('tax_country_id') border-danger @enderror">
            ...
            <div class="mt-10">
                ...
                <div class="border flex items-center rounded-sm mt-4 px-5 @error('tax_currency_id') border-danger @enderror">
            ...
            <div class="mt-10">
                ...
                <div class="border flex items-center rounded-sm mt-4 px-5 @error('tax_cost_model_id') border-danger @enderror">
