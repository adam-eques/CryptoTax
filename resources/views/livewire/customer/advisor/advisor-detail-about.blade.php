    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 py-8 gap-0 md:gap-10">
        <div class="col-span-2 px-0 sm:px-10">
            <div class="grid grid-cols-1 md:grid-cols-7 gap-x-0 md:gap-x-5 gap-y-3 w-full lg:w-2/3">
                ...
                <button class="col-span-4 bg-primary-50 hover:bg-primary py-3 px-10 rounded-full text-md font-bold text-white hover:text-white flex items-center space-x-12 justify-left"> 
                    <img src="{{asset('assets/img/icon/investment_avatar.svg')}}" class="w-10 h-10"/>
                    Financial investment broker 
                </button>
                <button class="col-span-3 bg-primary-50 hover:bg-primary py-3 px-10 rounded-full text-md font-bold text-white hover:text-white flex items-center space-x-12 justify-left"> 
                    <img src="{{asset('assets/img/icon/insurance_avatar.svg')}}" class="w-10 h-10"/>
                    Insurance Agent 
                </button>
                <button class="col-span-4 bg-primary-50 hover:bg-primary py-3 px-10 rounded-full text-md font-bold text-white hover:text-white flex items-center space-x-12 justify-left">
                    <img src="{{asset('assets/img/icon/brocker.svg')}}" class="w-10 h-10"/> 
                    Real estate loan broker  
                </button>
            </div>
            <div class="pt-10">
                <span class="text-xl font-extrabold text-primary">Profile of Thomas Eckert</span>
                <div class="pt-5">
                    <span class="text-md sm:text-lg text-gray-600">
                        After my Abitur in 2001 and the subsequent community service at the Christy Brown School for the Physically Handicapped, I began studying industrial engineering at the Westphalian University in Recklinghausen in September 2002. During this course of studies, I started my own business as an asset advisor for Deutsche Vermögensberatung AG in March 2004. At the end of 2005 I was drawn back to my hometown, where I still live and work now. After completing my diploma thesis and my studies, I then concentrated completely on advising private and business clients.
                    </span>
                </div>
            </div>
            <div class="pt-10">
                <span class="text-xl font-extrabold text-primary">Advisory approach</span>
                <div class="pt-5">
                    <span class="text-md sm:text-lg text-gray-600">
                        The future of first-class financial advice and support lies in the fact that a specialist and expert takes a each individual area depending on the situation and the result holistic view of . With this consulting approach, I emphasize my commitment to the “whole life principle” , based on a partnership and long-term relationship with my clients from Herten and the entire Ruhr area.<br/><br/>
                        In doing so, I deliver the performance promise of a homogeneous, demanding quality in terms of financial advice.
                    </span>
                </div>
            </div>
            <div class="pt-10">
                <span class="text-xl font-extrabold text-primary">Reviews from customers</span>
                <div class="pt-5 grid grid-cols-1 lg:grid-cols-12 gap-y-3 lg:gap-y-0">
                   <div class="col-span-5 border px-5 py-10 h-full bg-gray-100 mx-2">
                       <span class="text-secondary text-lg">1059 audited reviews </span>
                       <div class="space-y-3 mt-5">
                            <div class="grid grid-cols-12 w-full gap-3 items-center">
                                <p class="col-span-3">5 Stars</p>
                                <div class="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700 col-span-7">
                                        <div class="bg-primary h-1.5 rounded-full" style="width: 45%"></div>
                                    </div>   
                                <p class="col-span-2">887</p>
                            </div>
                            <div class="grid grid-cols-12 w-full gap-3 items-center">
                                <p class="col-span-3">4 Stars</p>
                                <div class="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700 col-span-7">
                                    <div class="bg-primary h-1.5 rounded-full" style="width: 23%"></div>
                                </div>   
                                <p class="col-span-2">196</p>
                            </div>
                            <div class="grid grid-cols-12 w-full gap-3 items-center">
                                <p class="col-span-3">3 Stars</p>
                                <div class="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700 col-span-7">
                                    <div class="bg-primary h-1.5 rounded-full" style="width: 12%"></div>
                                </div>   
                                <p class="col-span-2">15</p>
                            </div>
                            <div class="grid grid-cols-12 w-full gap-3 items-center">
                                <p class="col-span-3">2 Stars</p>
                                <div class="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700 col-span-7">
                   ...
                   <div class="col-span-7 border h-full bg-gray-100 mx-2 px-5 py-10">
                        <span class="text-secondary text-lg">1059 audited reviews </span>
                        <div class="w-full mt-5">
                            <div class="grid grid-cols-12 w-full gap-3 items-center border-b pb-4">
                                <p class="col-span-3 sm:col-span-4">Mortgage lending</p>
                                <div class="flex justify-between col-span-5 sm:col-span-4 px-5">
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                </div>   
                                <p class="col-span-4">4.9 (283 ratings )</p>
                            </div>
                            <div class="grid grid-cols-12 w-full gap-3 items-center border-b py-4">
                                <p class="col-span-3 sm:col-span-4">Investment</p>
                                <div class="flex justify-between col-span-5 sm:col-span-4 px-5">
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                            ...
                            <div class="grid grid-cols-12 w-full gap-3 items-center border-b py-4">
                                <p class="col-span-3 sm:col-span-4">Retirement provision</p>
                                <div class="flex justify-between col-span-5 sm:col-span-4 px-5">
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                            ...
                            <div class="grid grid-cols-12 w-full gap-3 items-center border-b py-4">
                                <p class="col-span-3 sm:col-span-4"> Insurance</p>
                                <div class="flex justify-between col-span-5 sm:col-span-4 px-5">
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                            ...
                            <div class="grid grid-cols-12 w-full gap-3 items-center border-b py-4">
                                <p class="col-span-3 sm:col-span-4"> Property</p>
                                <div class="flex justify-between col-span-5 sm:col-span-4 px-5">
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                            ...
                            <div class="grid grid-cols-12 w-full gap-3 items-center border-b py-4">
                                <p class="col-span-3 sm:col-span-4">Private Banking</p>
                                <div class="flex justify-between col-span-5 sm:col-span-4 px-5">
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
                                    <img src="{{asset('assets/img/icon/star.svg')}}" class="w-5 h-5"/>
