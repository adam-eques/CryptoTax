                        ...
                        <div class="flex flex-col divide-y divide-gray-300 scrollbar overflow-auto max-h-100" x-on:click="category=`{{ $row['label'] }}`; action=''">
                            @foreach($row["items"] as $item)
                                @if (  $row['id'] == 1)
                                    ...
                                    >
                                        <div class="grid grid-cols-2 w-2/3 gap-3 items-center">
                                            <img src="{{ asset('assets/img/exchange_icon/' . $item->getName() . '.svg' ) }}" class="w-36 h-auto pl-4 col-span-1"/>
                                ...
                                @elseif ($row['id'] == 3)
                                    ...
                                    >
                                        <div class="grid grid-cols-2 w-2/3 gap-3 items-center">
                                            <img src="{{ asset('assets/img/exchange_icon/' . explode(':',  $item->getName())[0] . '.svg' ) }}" class="w-36 h-auto pl-4 col-span-1"/>
                                            <div class="space-y-1 text-left col-span-1">
                ...
                @if($cryptoExchangeAccounts->count() || $blockchainAccounts->count())
                    ...
                    @elseif ($blockchain)
                        ...
                        <div>
                            ...
                            <div x-show="action == 'edit'" x-cloak>
