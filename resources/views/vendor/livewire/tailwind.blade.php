<div>
    @if ($paginator->hasPages())
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-center">  {{-- justify-between to justify-center --}}
                {{-- <div>
                ...
                <div>
                    <span class="relative z-0 inline-flex rounded-md shadow-sm space-x-2"> {{-- Add space-x-2 --}}
                        <span>
                            {{-- Previous Page Link --}}
                            @if ($paginator->onFirstPage())
