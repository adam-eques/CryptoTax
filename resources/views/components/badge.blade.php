...
@php
    ...
    switch($size) {
        case 'sm': $sizeClass = 'px-3 py-1 text-xs font-bold'; break;
        case 'md': $sizeClass = 'px-5 py-2 text-lg font-bold'; break;
        case 'lg': $sizeClass = 'px-7 py-3 text-xl font-bold'; break;
        case 'xl': $sizeClass = 'px-9 py-4 text-2xl font-bold'; break;
    }
    switch($type) {
