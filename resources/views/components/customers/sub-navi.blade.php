            ...
            <div class="flex items-center justify-between ">
                ...
                @if(!empty($subnavi["actions"]))
                    <div class="flex items-center gap-1 lg:gap-3">
                        ...
                        <p class="text-gray-400 text-xs sm:text-base">{{ __('Balance') }} <span class=" text-lg sm:text-xl font-bold text-primary">{{number_format(auth()->user()->credits,2,'.',',') }}</span> {{ __('Credits') }}</p>
