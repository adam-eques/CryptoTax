        ...
        <x-container class="relative">
            ...
            <div class="text-center relative">
                <div class="grid grid-cols-1 md:grid-cols-2 2xl:gap-42 xl:gap-30 lg:gap-24 md:gap-10 gap-5 py-5">
                    <div class="">
                        <img src="{{asset('assets/img/svg/tax_capital_gain.svg')}}" class="w-full"/>
                    </div>
                    <div class="flex items-center">
                        <div class="my-auto">
                            <div class="flex items-center">
                                <img src={{asset('assets/img/svg/capital_coin_icon.svg')}} class="w-14"/>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 2xl:gap-42 xl:gap-30 lg:gap-24 md:gap-10 gap-5 py-5">
                    <div class="flex items-center order-2 md:order-1">
                        <div class="my-auto">
                            <div class="flex items-center">
                                <img src="{{asset('assets/img/svg/tax_transaction_income_icon.svg')}}" class="w-14"/>
                    ...
                    <div class="order-1 md:order-2">
                        <img src="{{asset('assets/img/svg/tax_transaction_income.svg')}}" class="w-full"/>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 2xl:gap-42 xl:gap-30 lg:gap-24 md:gap-10 gap-5 py-5">
                    <div class="">
                        <img src="{{asset('assets/img/svg/tax-checklist_report.svg')}}" class="w-full"/>
                    </div>
                    <div class="flex items-center">
                        <div class="my-auto">
                            <div class="flex items-center">
                                <img src="{{asset('assets/img/svg/tax_checklist_icon.svg')}}" class="w-14"/> 
                            ...
                            <div class="flex items-center mt-9">
                                <img src="{{ asset('assets/img/svg/tax_report_icon.svg') }}" class="w-14"/>
