    ...
    <div class="w-full bg-white">
        ...
        <x-container class="py-14">
            <div class="relative">
                ...
                <p class="my-8 text-lg font-semibold">{{  __('Information we collect') }}</p>
                ...
                <p class="my-8 text-lg font-semibold">{{  __('How we use your information') }}</p>
                ...
                @foreach ($terms as $term)
                    <div class="flex items-start py-2 cl">
                ...
                <p class="my-8 text-lg font-semibold">{{  __('Log Files') }}</p>
                ...
                <p class="my-8 text-lg font-semibold">{{  __('Cookies and Web Beacons') }}</p>
                ...
                <p class="my-8 text-lg font-semibold">{{  __("Children's Information") }}</p>
