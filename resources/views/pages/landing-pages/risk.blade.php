<x-guest-layout title="Risk">
    ...
    <div class="relative py-12 bg-white">
        <x-container class="text-primary">
            ...
            <p class="mt-3 text-gray-400">{{ __('Last updated  February 06, 2022') }}</p>
            <h6 class="mt-8 text-lg font-semibold">{{ __('Website Disclaimer') }}</h6>
            ...
            <h6 class="mt-8 text-lg font-semibold">{{ __('AFFILIATES DISCLAIMER') }}</h6>
            ...
            <div class="flex items-center my-8 text-white group">
            ...
            <h6 class="mt-8 text-lg font-semibold">{{ __('TESTIMONIALS DISCLAIMER') }}</h6>
