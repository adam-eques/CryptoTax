<x-app-layout>
    @if(auth()->user()->isCustomerAccount())
        <x-page icon="fas-home" :title="__('Dashboard')">
            <p class="block font-bold mb-3">Hier entsteht das Dashboard. Folgende Click-Dummies gibt es:</p>
            <ul class="list-disc block mb-6 p-5">
            ...
            <livewire:crypto-exchange-accounts.list-accounts />
